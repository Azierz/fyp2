...
// Run after submit form [NEED TO CHANGE]
		...
		if ($num > 0) { // If it ran OK, display the records.
			...
			<form action="profile.php" method="POST">
				<table align="center" cellspacing="10" cellpadding="10" width=400vh>
					...
					<tr>
						<td id = "table_profile" style="width:50vh;"><textarea class="textprofile" name="aboutme" rows="4" cols="42" value="' . $row['about_me'] . '"></textarea></td>
					</tr>
				</table>
				...
				<table align="center" cellspacing="10" cellpadding="10" width=400vh>
					...
					<tr>
						...
						<td><input class="form-submit-button" style="width:auto; height:fit-content; font-size: 14px; margin-left:35%" type="submit" name="submit" value="Save Changes"></td>
					</tr>
					';
